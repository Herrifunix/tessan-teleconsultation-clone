// Correspondances code postal → département → région (mêmes tables que l'original).
export const DEPARTMENT_REGION: Record<string, string> = {
  ...
  '18': 'Centre-Val de Loire', '19': 'Nouvelle-Aquitaine', '21': 'Bourgogne-Franche-Comté', '22': 'Bretagne',
  '23': 'Nouvelle-Aquitaine', '24': 'Nouvelle-Aquitaine', '25': 'Bourgogne-Franche-Comté', '26': 'Auvergne-Rhône-Alpes',
  '27': 'Normandie', '28': 'Centre-Val de Loire', '29': 'Bretagne', '2A': 'Corse', '2B': 'Corse', '30': 'Occitanie',
  ...
  '44': 'Pays de la Loire', '45': 'Centre-Val de Loire', '46': 'Occitanie', '47': 'Nouvelle-Aquitaine', '48': 'Occitanie',
  '49': 'Pays de la Loire', '50': 'Normandie', '51': 'Grand Est', '52': 'Grand Est', '53': 'Pays de la Loire',
  '54': 'Grand Est', '55': 'Grand Est', '56': 'Bretagne', '57': 'Grand Est', '58': 'Bourgogne-Franche-Comté',
  '59': 'Hauts-de-France', '60': 'Hauts-de-France', '61': 'Normandie', '62': 'Hauts-de-France', '63': 'Auvergne-Rhône-Alpes',
  ...
  '83': "Provence-Alpes-Côte d'Azur", '84': "Provence-Alpes-Côte d'Azur", '85': 'Pays de la Loire', '86': 'Nouvelle-Aquitaine',
...
export const DEPARTMENT_NAME: Record<string, string> = {
  ...
  '28': 'Eure-et-Loir', '29': 'Finistère', '2A': 'Corse-du-Sud', '2B': 'Haute-Corse', '30': 'Gard', '31': 'Haute-Garonne',
  ...
  '74': 'Haute-Savoie', '75': 'Paris', '76': 'Seine-Maritime', '77': 'Seine-et-Marne', '78': 'Yvelines', '79': 'Deux-Sèvres',
  '80': 'Somme', '81': 'Tarn', '82': 'Tarn-et-Garonne', '83': 'Var', '84': 'Vaucluse', '85': 'Vendée', '86': 'Vienne',
  '87': 'Haute-Vienne', '88': 'Vosges', '89': 'Yonne', '90': 'Territoire de Belfort', '91': 'Essonne', '92': 'Hauts-de-Seine',
  '93': 'Seine-Saint-Denis', '94': 'Val-de-Marne', '95': "Val-d'Oise",
};

export const REGIONS: string[] = [...new Set(Object.values(DEPARTMENT_REGION))];
export const DEPARTMENTS: string[] = Object.values(DEPARTMENT_NAME);

/** Code département à partir d'un code postal (Corse : 200xx/201xx → 2A, sinon 2B). */
export function departmentCode(postalCode: string): string {
  if (!postalCode || postalCode.length < 2) return '';
  if (postalCode.startsWith('20')) return postalCode[2] === '0' || postalCode[2] === '1' ? '2A' : '2B';
  return postalCode.slice(0, 2);
}
export const regionOf = (postalCode: string) => DEPARTMENT_REGION[departmentCode(postalCode)] || '';
export function departmentNameOf(postalCode: string): string {
  const c = departmentCode(postalCode);
  return DEPARTMENT_NAME[c] || c;
}
